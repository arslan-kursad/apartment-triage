...
namespace ApartmentTriage.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260601185742_202606012157_AddApiUsageRecord")]
    partial class _202606012157_AddApiUsageRecord
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApartmentTriage.Domain.Entities.ApiUsageRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("CreatedAt")
                        .HasDatabaseName("ix_api_usage_records_created_at");

                    b.HasIndex("Model", "CreatedAt")
                        .HasDatabaseName("ix_api_usage_records_model_created_at");
            ...
            modelBuilder.Entity("ApartmentTriage.Domain.Entities.Ticket", b =>
                {
                    ...
                    b.Property<bool>("EscalatedToSonnet")
                        .HasColumnType("boolean")
                        .HasColumnName("escalated_to_sonnet");
