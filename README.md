...
- [ADR-0001](docs/decisions/0001-custom-orchestrator-over-semantic-kernel.md) — a ~300-LOC custom orchestrator over a general agent framework, for transparency and control.
