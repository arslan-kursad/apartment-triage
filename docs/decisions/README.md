...
- 0002: Custom orchestrator vs Semantic Kernel (Day 0 kararı — retroactive)
- 0003: WhatsApp Cloud API direct vs Twilio BSP (Day 0 kararı — retroactive)
- 0004: Anthropic SDK yerine HttpClient + System.Text.Json (Day 0 kararı)

ADR template'i Architect kurulurken belirlenecek.
