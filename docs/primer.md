...
- **Mod ayrımı:**
  ...
  - *İngilizce çıktı (Kyle email, GitHub README, agent prompt'ları, eval rationale):* preposition, tense, ton, kültürel nüans seviyesinde titizlik. Bu en yüksek dikkat seviyesi.
...
- **Ad:** Kürşad
- **GitHub:** arslan-kursad
- **Kyle ile geçmiş yazışma tonu:** İlk temas Day 0 holding email'i ile Kürşad → Kyle yönüyle başladı. Kyle yanıt verdiğinde bu satır güncellenecek (tonu okuyup buraya not düşülür).
